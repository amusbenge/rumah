                    ...
                    foreach ($kepkel as $kk) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-circle btn-sm" href="<?= base_url('admin/hapus_kepkel/') ?><?= $kk['no_kk']; ?>" data-toggle="tooltip" title="Hapus" onclick="return confirm('Yakin ingin menghapus Kepala Keluarga ini?')">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="p-3">
                    ...
                    <form action="<?= base_url('admin/tmbh_kepkel/') ?>" method="POST" enctype="multipart/form-data">
